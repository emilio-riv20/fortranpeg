...
function peg$parse(input, options) {
  ...
  var peg$f9 = function() {return new n.Punto()};
  var peg$f10 = function() {return new n.Fin()};
  var peg$f11 = function(bottom, top) {
    return new n.Rango(bottom, top);
  };
  var peg$f12 = function(num) { return parseInt(num.join('')); };
  ...
  function peg$parsecorchetes() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$parsecontenidoCorchetes();
      if (s3 !== peg$FAILED) {
        while (s3 !== peg$FAILED) {
          s2.push(s3);
          s3 = peg$parsecontenidoCorchetes();
  ...
  function peg$parsecontenidoCorchetes() {
    var s0, s1, s2, s3;
